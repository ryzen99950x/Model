namespace ShoppingSite.Models
{
    public class Product
    {
        ...
        public Categories Category { get; set; }  // 商品が所属するカテゴリーへのナビゲーション
        public Gender Gender { get; set; }      // 商品の男女区別へのナビゲーション
        // 他の関連するエンティティへのナビゲーションプロパティを追加することもできます

        // コメントや他の特記事項があれば、必要に応じて追加してください
    }
}
